...
FUNCTION hel2arcmin, ns, ew, visible, date=datin, soho=soho, error=error, $
                     b0=b0_kw,l0=l0_kw,p=p_kw,r0=r_kw,angles=angles
...
;
   if not isvalid(r_kw) or not isvalid(p_kw) or not isvalid(b0_kw) then begin
	;
